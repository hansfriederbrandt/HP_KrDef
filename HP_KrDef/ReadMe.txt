========================================================================
    KONSOLENANWENDUNG: HP_KrDef-Projektübersicht
========================================================================

Diese HP_KrDef-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre HP_KrDef-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen HP_KrDef.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
